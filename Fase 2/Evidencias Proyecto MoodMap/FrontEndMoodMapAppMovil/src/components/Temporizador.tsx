//C:\Moodmap\src\components\Temporizador.tsx
...
// Declaración explícita del tipo de props (aunque en este caso no se usan props)
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.buttons}>
        ...
        >
          <FontAwesome name={isRunning ? 'pause' : 'play'} size={25} color="white" />
        </TouchableOpacity>
